...
{
  auto link_ptr = std::make_shared<boost_graph_issue::Link>(std::move(link));
...
bool SceneGraph::addJoint(boost_graph_issue::Joint joint)
{
  auto joint_ptr = std::make_shared<boost_graph_issue::Joint>(std::move(joint));
  return addJoint(joint_ptr);
}

bool SceneGraph::addJoint(boost_graph_issue::Joint::Ptr joint_ptr)
{
...
namespace
{
boost_graph_issue::Link clone_prefix(boost_graph_issue::Link::ConstPtr link, const std::string& prefix)
{
  return link->clone(prefix + link->getName());
}

boost_graph_issue::Joint clone_prefix(boost_graph_issue::Joint::ConstPtr joint, const std::string& prefix)
{
...
bool SceneGraph::insertSceneGraph(const boost_graph_issue::SceneGraph& scene_graph, const std::string& prefix)
{
...
bool SceneGraph::insertSceneGraph(const boost_graph_issue::SceneGraph& scene_graph,
                                  boost_graph_issue::Joint joint,
