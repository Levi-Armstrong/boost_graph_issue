 ...
 */
#ifndef BOOST_GRAPH_ISSUE_GRAPH_H
#define BOOST_GRAPH_ISSUE_GRAPH_H
...
#include <boost_graph_issue/link.h>
#include <boost_graph_issue/joint.h>
#include <boost_graph_issue/allowed_collision_matrix.h>
...
public:
   ...
   * different names
   */
  bool insertSceneGraph(const boost_graph_issue::SceneGraph& scene_graph, const std::string& prefix = "");
   ...
   * names
   */
  bool insertSceneGraph(const boost_graph_issue::SceneGraph& scene_graph,
...
#endif  // BOOST_GRAPH_ISSUE_GRAPH_H
